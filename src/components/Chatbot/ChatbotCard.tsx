...
const ChatbotCard: React.FC = () => {
  ...
  return (
    <div className={`bg-gray-700 dark:bg-gray-800/50 rounded-xl shadow-sm flex flex-col h-full transition-all`}>
      <div className="p-4 border-b border-gray-600 dark:border-gray-700 flex items-center justify-between">
        <div>
          <h2 className="font-semibold text-white">AI Assistant</h2>
          <p className="text-sm text-gray-300 dark:text-gray-400">Powered by GPT-4</p>
        </div>
        <button 
      ...
      <div className={`flex-1 overflow-y-auto p-4 space-y-4 ${isCollapsed ? 'hidden' : ''}`}>
        ...
        {isLoading && (
          <div className="flex justify-start">
            <div className="bg-gray-600 dark:bg-gray-700 rounded-2xl px-4 py-2 text-gray-300 dark:text-gray-400">
      ...
      <div className={`p-4 border-t border-gray-600 dark:border-gray-700 ${isCollapsed ? 'hidden' : ''}`}>
        <div className="flex items-center">
          <button className="p-2 rounded-full hover:bg-gray-600 dark:hover:bg-gray-700 transition-colors text-gray-300 dark:text-gray-400">
            <Plus size={18} />
          </button>
          <button className="p-2 rounded-full hover:bg-gray-600 dark:hover:bg-gray-700 transition-colors text-gray-300 dark:text-gray-400">
            <Paperclip size={18} />
          ...
          <div className="flex-1 mx-2">
            <textarea
              ...
              className="w-full border border-gray-600 dark:border-gray-600 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none
                bg-gray-600 dark:bg-gray-700 text-white placeholder-gray-300 dark:placeholder-gray-400"
              rows={1}
              disabled={isLoading}
            />
          </div>
          ...
          <button
            ...
            className={`p-2 rounded-full transition-colors ${
              input.trim() === '' || isLoading
                ? 'bg-gray-600 dark:bg-gray-700 text-gray-400 dark:text-gray-500' 
